...
public class UserService : IUserService
{
    ...
    public async Task<UserForShowViewModels> GetUserForShow(string moblile)
    {
        return await _userRepository.GetUserForShow(moblile);
    }
    ...
    public async Task<ChangePasswordResult?> CompareOldPassword(string oldPassword, string mobile)
    {
        if (!await _userRepository.CompareOldPassword(oldPassword, mobile))
            return ChangePasswordResult.WrongPassword;
        
        return null;
    }

    public async Task<ChangePasswordResult> ChangeUserPassword(string mobile, string newPassword)
    {
       await _userRepository.ChangeUserPassword(mobile, newPassword);
